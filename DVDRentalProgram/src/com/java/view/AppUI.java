...
//	시작 화면 출력
	public static void startScreen() {
		System.out.println("\n---------- DVD 대여 관리 시스템 ----------");
		System.err.println("### 1. 회원 관리 시스템");
		System.err.println("### 2. 대여 주문 관리 시스템");
		System.err.println("### 3. 영화 DVD 관리 시스템");
		System.err.println("### 4. 프로그램 종료");
		System.out.println("-----------------------------------");
		System.out.print(">>> ");
	}
	
	//회원 관리 시스템 화면 출력
	public static void userManagermentScreen() {
		System.out.println("\n---------- 대여 주문 관리 시스템 ----------");
